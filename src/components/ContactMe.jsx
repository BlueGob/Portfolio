        ...
        <div id={id} className="pt-40 md:pl-20 md:pr-10  pr-5">
            ...
            <div className="grid md:grid-cols-2 grid-col-1 pt-20 pb-20 md:text-left text-center">
                <div className="order-2 md:order-1">
                    <motion.div viewport={{ once: true }} initial={{ x:-100,opacity:0}} transition={{ duration:0.5}} whileInView={{ opacity: 1,x:0 }} className="text-white md:text-3xl text-2xl justify-between pb-10 ">
                        Software Engineer | ML/DL developer | Problem solving
                    </motion.div>
                    <motion.div viewport={{ once: true }} initial={{ x:-100,opacity:0}} transition={{ duration:0.5}} whileInView={{ opacity: 1,x:0 }} className="text-white text-xl font-thin pb-10">
                ...
                <motion.div viewport={{ once: true }} initial={{ x:100,opacity:0}} transition={{ duration:0.5}} whileInView={{ opacity: 1,x:0 }} className="w-60 h-60 md:w-80 md:h-80 md:mr-32 md:justify-self-end justify-self-center mb-12 md:-mt-28 order-1 md:order-2">
