        ...
        <div id={id} className="md:pl-20 pl-5 md:pr-20 text-white">
            ...
            <div className="grid md:grid-cols-2 grid-cols-1">
                ...
                <div>
                    ...
                    <motion.ul viewport={{ once: true }} initial={{ x:isMobile?0:200, opacity: 0 }} transition={{ duration: 0.5 }} whileInView={{ opacity: 1, x: 0 }} className="mt-16 text-xl space-y-3 font-thin">
